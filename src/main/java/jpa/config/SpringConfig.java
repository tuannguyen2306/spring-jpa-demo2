...
public class SpringConfig {
    ...
    DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/spring-jpa-demo2"); //spring-jpa-1: database name
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        // base package to scan for jpa.entity classess
        entityManager.setPackagesToScan("jpa.entity");

        // JPA properties
        Properties jpaProperties = new Properties();
        jpaProperties.setProperty("hibernate.dialect", "org.hibernate.dialect.MySQLDialect");
        jpaProperties.setProperty("hibernate.hbm2ddl.auto", "none"); // update or create
